...
function install(){
  ...
  $('#activity')?.insertAdjacentHTML('beforebegin',`<section id="printing-cost" class="view printing-cost-only"><div class="grid"><div class="kpi"><b>Printing Products</b><strong id="pcProducts">0</strong></div><div class="kpi"><b>Default Baseline</b><strong>₱0.80</strong></div><div class="kpi"><b>Additional Color</b><strong>+₱0.10</strong></div><div class="kpi"><b>Highest Cost</b><strong id="pcHighest">₱0.80</strong></div></div><div class="section"><div class="head"><div><h2>Printing Cost</h2><div class="mini printing-cost-note">Save the printing price EcoHub pays per product. New supplier quotations automatically use this saved price; products without a saved price start at ₱0.80 per piece.</div></div><div class="tools"><button id="addColorSurcharge" class="btn">+ Additional Color (+₱0.10)</button><button id="addPrintingCost" class="btn dark">+ Add Product / Cost</button></div></div><div class="wrap"><table><thead><tr><th>Product</th><th>Category</th><th>Code</th><th class="num">Printing Cost</th><th>Unit</th><th>Notes</th><th>Updated</th><th></th></tr></thead><tbody id="printingCostBody"></tbody></table></div></div></section>`);
  ...
  $('#addColorSurcharge').onclick=()=>{openCost();$('#pcName').value='Additional Color';$('#pcCategory').value='Other Printing';$('#pcPrice').value='0.10';$('#pcUnit').value='Piece';$('#pcNotes').value='Additional charge for a different or extra print color';};
